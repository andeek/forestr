#' 10,000 Simulated particles to emulate Higgs boson discovery
#'
...
#' @usage data(higgs_1)
#'
#' @format A data frame with 10000 rows and 29 variables:
#' \describe{
...
#' to resemble properties measured by particle detectors in an accelerator
#' to detect the Higgs Boson particle. This dataset created by sampling observations
#' to ensure the percentage of unbalancedness is 2%.
#'
#' @docType data
#' @keywords datasets
#' @name higgs_2
