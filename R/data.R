#' 200 Simulated particles to emulate Higgs boson discovery
#'
...
#' to ensure the percentage of unbalancedness is 5%.
#'
#' @docType data
#' @keywords datasets
#' @name higgs_5
#' @usage data(higgs_5)
#'
#' @format A data frame with 200 rows and 29 variables:
#' \describe{
...
#' to resemble properties measured by particle detectors in an accelerator
#' to detect the Higgs Boson particle. This dataset created by sampling observations
#' to ensure the percentage of unbalancedness is 10%.
#'
#' @docType data
#' @keywords datasets
#' @name higgs_10
...
#' to resemble properties measured by particle detectors in an accelerator
#' to detect the Higgs Boson particle. This dataset created by sampling observations
#' to ensure the percentage of unbalancedness is 25%.
#'
#' @docType data
#' @keywords datasets
#' @name higgs_25
...
#' (test) 200 Simulated particles to emulate Higgs boson discovery
#'
#' A dataset containing simulated data produced using Monte Carlo
#' to resemble properties measured by particle detectors in an accelerator
#' to detect the Higgs Boson particle. This dataset created by sampling observations
